...
<body>
    ...
    <div class="container-fluid">
        <div class="row ">
            <div class="col-lg-6">
                <h1 class="mb-4 mt-4">Multas vehiculares</h1>
            </div>
            <div class="col-lg-6">
                <form action="./CImulta_vehicular.php">
                    <div class="row">
                        <?php
                            ...
                            if($_SESSION['Admin'] == 1){
                                print('
                                    <div class="col-lg-4">
                                        <a href="./../add/Fmulta_vehicular.php" class="btn btn-primary float-right mb-4 mt-4">Añadir multa</a>
                                    </div>
                                ');
                                generar_buscar($SQL);
                            } else {
